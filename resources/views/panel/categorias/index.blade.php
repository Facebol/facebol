                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                  <a class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modal-detalle-{{$categoria->id}}"><i class="fa fa-eye"></i></a>
                                  @if($categoria->activo==1)
                                  <a href="{{route('actividades.show',$categoria->id)}}" class="btn btn-info btn-sm"><i class="fa fa-check"></i></a>
                                  @else
                                  <a href="{{route('actividades.show',$categoria->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-remove"></i></a>
                                  @endif
                                  <a href="{{route('actividades.edit',$categoria->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
