                ...
                <section class="wrapper">
                    ...
                    <div class="row mt">
                        ...
                        <div class="form-panel wrap">
                            {!!Form::model($usuario, ['route' => ['user.update', $usuario->id],'class'=>'form-horizontal style-form formulario','method'=>'PUT','files'=>true])!!}
                            <h3 class="text-center"><i class="fa fa-user"></i> Edicion de Usuario</h3>
                                @include('panel.panel-a.user.form.form')
                                ...
                                <div class="form-group">       
                                    <div class="col-sm-12 center-block">                
                                        <a href="{{route('user.index')}}" class="btn btn-primary btn-block btn-round" ><i class="fa fa-chevron-circle-left"></i> Regresar</a>
                                    </div>
                                </div>
                            {!!Form::close()!!}
                        </div>
