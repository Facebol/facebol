                          ...
                          <table class="table table-striped table-advance table-hover">
                              ...
                              @foreach($clientes as $cliente)
                                <tr> 
                                    ...
                                    <td> 
                                          <a href="#" data-target="#modal-open-{{$cliente->id}}" data-toggle="modal" class="btn btn-success btn-xs">
                                          <i class="fa fa-plus"></i></a>
                                          <a href="{{route('servicio.show',$cliente->id)}}" class="btn btn-primary btn-xs"><i class="fa fa-database"></i></a>
                                    </td>
                                </tr> 
                                @include('panel.panel-a.servicio.modal')
                             @endforeach
                              </tbody>
                          </table>
